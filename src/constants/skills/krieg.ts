    ...
    red: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            '<explosive>Kill Skill</explosive>: Killing an enemy increases your <incendiary>Incendiary</incendiary> <skill>Status Effect Damage</skill> and <incendiary>Incendiary</incendiary> <skill>Status Effect Chance</skill>.<br /> <span class="font-skill">Chance to light yourself on fire when you DoT an enemy.</span>',
          details: [
            {
